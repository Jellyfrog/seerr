...
const filteredMainSettings = (
  ...
  // Derived rather than stored, so that every consumer of the single flag
...
settingsRoutes.post('/main', async (req, res, next) => {
  ...
  // The single media server switch (sent by the settings page and older
  // clients) governs the media server's own sign-in. Apply it to that provider
  // rather than storing a value nothing reads.
